...
TEST(ToStringTest, to_string_expression_of_every_should_return_enbraced_list_of_params_strings_separated_by_and) {
    Every<A, B> x;
    EXPECT_EQ(toString(x), "('a' and 'b')");
}

TEST(ToStringTest, to_string_expression_of_any_should_return_enbraced_list_of_params_strings_separated_by_or) {
    Any<A, B> x;
    EXPECT_EQ(toString(x), "('a' or 'b')");
}

TEST(ToStringTest, to_string_expression_of_first_should_return_enbraced_list_of_params_strings_separated_by_or) {
    First<A, B> x;
    EXPECT_EQ(toString(x), "('a' or 'b')");
}

TEST(ToStringTest, to_string_expression_of_every_with_optional_should_return_enbraced_list_of_params_strings_separated_by_and_optional_with_prefix) {
    Every<A, Optional<B>> x;
    EXPECT_EQ(toString(x), "('a' and optional 'b')");
}

TEST(ToStringTest, to_string_tuple_of_two_values_should_return_enbraced_list_of_params_strings_separated_by_comma) {
    std::tuple<A, B> x;
    EXPECT_EQ(toString(x), "('a', 'b')");
}
